...
<body>
    <div id="wrap">
            ...
            <div id="contents">
                <div class="findpw_inner">
                    <div class="findpw_main_Contents_inner">
                        <div class="findpw_main_Contents_h2">
                            <h2>비밀번호 찾기</h2>
                        </div>
                        <div class="findpw_main_Contents_move">
                            <div class="findpw_main_Contents_form">
                                <form action="../process/findpw_process.php" method="post">
                                    <div class="findpw_main_Contents_st">
                                        <div class="findpw_main_Contents_st_triangle">
                                    ...
                                    <div class="findpw_main_Contents_ed">
