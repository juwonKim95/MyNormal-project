...
<body>
    <div id="wrap">
            ...
            <div id="contents">
                <div class="findid_inner">
                    <div class="findid_main_Contents_inner">
                        <div class="editpw_main_Contents_h2">
                            <h2>아이디 찾기</h2>
                        </div>
                        <div class="findid_main_Contents_move">
                            <div class="findid_main_Contents_form">
                                <form action="../process/findid_process.php" method="post">
                                    <div class="findid_main_Contents_st">
                                        <div class="findid_main_Contents_st_triangle">
                                    ...
                                    <div class="findid_main_Contents_ed">
